...
data_metadata_path="${script_dir}/../stratify/out/data/data_import/preprocessing/data_preprocessing/stratify/data_stratify/default/data_import.metadata.json.gz"
if [[ ! -f "$data_metadata_path" ]]; then
  for candidate in \
    "${script_dir}/out/data/data_import/default/data_import.metadata.json.gz" \
    "${script_dir}/../preprocessing/out/data/data_import/preprocessing/data_preprocessing/default/data_import.metadata.json.gz" \
    "${script_dir}/../data/out/data/data_import/default/data_import.metadata.json.gz"; do
    if [[ -f "$candidate" ]]; then
